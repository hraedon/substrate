...
class ErrorCode(StrEnum):
    ...
    VALIDATOR_TIMEOUT = "VALIDATOR_TIMEOUT"  # obsolete per BC-192; kept for back-compat
    VALIDATOR_FAILED = "VALIDATOR_FAILED"
    VALIDATOR_IO_UNSAFE = "VALIDATOR_IO_UNSAFE"  # obsolete per BC-192; kept for back-compat
